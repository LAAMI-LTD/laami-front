...
function AuthContent() {
  ...
  return (
    ...
    >
      ...
      {/* Background shapes - keep all your existing shapes here */}
      <div
...
function AuthLoading() {
  return (
    <section className="bg-gray-800 relative min-h-screen py-8 sm:py-12 md:py-16 lg:py-20 mt-6 flex items-center justify-center px-3 xs:px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="fixed inset-0 z-0">
        <div
          className="absolute inset-0 lg:hidden"
          style={{
