      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            // Optional: Use a different image for ultra-wide screens
            // srcSet="/hero.avif 1920w, /hero-wide.avif 3840w"
          />
          ...
          ">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-300">Legal compliance built-in</span>
              </li>
              <li className="flex items-start">
