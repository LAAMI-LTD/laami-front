...
export const professionalProjects: ProjectType[] = [
  {
    ...
    logo: "/portfolio/64/logo.webp",
    images: [
      "/portfolio/64/home1.png",
      "/portfolio/64/sset1.png",
      "/portfolio/64/courses1.png",
      "/portfolio/64/more1.png",
      "/portfolio/64/home2.png",
      "/portfolio/64/contact2.png",
    ],
    tech: [
      "Next.js",
      "React",
